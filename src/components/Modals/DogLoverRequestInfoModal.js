                            ...
                            <MKBox p={2}>
                                <form >
                                    <MKBox pt={1} pb={2}>
                                        ...
                                        >
                                            <MKTypography variant="h5">{selectedDogRequest.status} Request</MKTypography>
                                    ...
                                    >
                                        ...
                                        <MKTypography>
                                            {selectedDogRequest.status === 'Pending' ? "" : selectedDogRequest.owner_message === '' || selectedDogRequest.owner_message === undefined
                                                ? 'No message from owner.' : selectedDogRequest.owner_message}
